...
#[repr(C)]
#[derive(DropStructMacro)]
pub struct fil_GeneratePoStVanillaResponse {
    pub error_msg: *const libc::c_char,
    pub status_code: FCPResponseStatus,
    pub vanilla: *const libc::c_char,
}

impl Default for fil_GeneratePoStVanillaResponse {
    fn default() -> fil_GeneratePoStVanillaResponse {
        fil_GeneratePoStVanillaResponse {
            vanilla: ptr::null(),
            error_msg: ptr::null(),
            status_code: FCPResponseStatus::FCPNoError,
        }
...
code_and_message_impl!(fil_GeneratePoStVanillaResponse);